 ...
 * @license MIT
 */
import { ComponentRef, ElementRef, EmbeddedViewRef, ResolvedReflectiveProvider, ViewContainerRef, Renderer } from '@angular/core';
import { DialogRef } from '../models/dialog-ref';
import { BaseDynamicComponent } from '../components/index';
export interface ComponentLinkerData {
    component: any;
