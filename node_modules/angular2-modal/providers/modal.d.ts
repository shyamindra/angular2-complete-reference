 ...
 * @license MIT
 */
import { ComponentRef, TemplateRef, ResolvedReflectiveProvider, Type, Renderer } from '@angular/core';
...
export declare abstract class Modal {
    ...
    protected createContainer<T>(dialogRef: DialogRef<any>, ContainerComponent: Class<T>, content: string | TemplateRef<any> | Type, bindings?: ResolvedReflectiveProvider[]): ComponentRef<T>;
    /**
